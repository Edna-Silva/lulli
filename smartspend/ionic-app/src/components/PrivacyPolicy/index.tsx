...
const PrivacyPolicy = ({ PrivacyPolicyModalOpen, PrivacyPolicyModalClose }: any) => {
  const PrivacyPolicy = useRef<HTMLIonModalElement>(null);

  const handleCompletePrivacyPolicy = async () => {};
