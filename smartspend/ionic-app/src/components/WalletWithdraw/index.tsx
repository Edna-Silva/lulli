...
import { useUpdateWalletMutation, useGetBankAccountsQuery, useUpdateBankAccountsMutation } from "../../services/backend";
import storage from "../../redux/store";

import { closeCircle, checkmarkCircle } from "ionicons/icons";

const WalletWithdraw = ({ withdrawFundsModalOpen, withdrawFundsModalClose }: any) => {
    ...
    return (
        <>
            <IonModal
                isOpen={withdrawFundsModalOpen}
                onDidDismiss={withdrawFundsModalClose}
            ...
            <IonModal isOpen={isConfirmOpen} ref={confirmOpenModal} className="confirm-deposit">
                <IonHeader>
                    <IonToolbar>
                        <div className="tool-bar-title"><IonIcon icon={closeCircle} aria-hidden={true} onClick={() => { setIsConfirmOpen(false) }} /><IonTitle>Confirm Withdrawal</IonTitle></div>
                    </IonToolbar>
                </IonHeader>
